...
from contact import contact_bp, mail
...
app.config['MAIL_USERNAME'] = 'fakereviewdetection8@gmail.com'  
app.config['MAIL_PASSWORD'] = 'msyiacxdorjatgev' 
app.config['MAIL_DEFAULT_SENDER'] = 'mailertemp50@gmail.com'

mail.init_app(app)

app.register_blueprint(contact_bp, name='contact_blueprint')
